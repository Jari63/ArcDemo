using ArcDemo.Core.Interfaces;
using ArcDemo.Core.Services;
using ArcDemo.Infrastructure.Data;
using ArcDemo.Infrastructure.Data.Queries;
using ArcDemo.UseCases.Contributors.List;

namespace ArcDemo.Infrastructure;
