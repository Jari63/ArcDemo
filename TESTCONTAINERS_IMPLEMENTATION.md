...
**Updated `tests\ArcDemo.FunctionalTests\ArcDemo.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\ArcDemo.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\ArcDemo.FunctionalTests\ArcDemo.FunctionalTests.csproj
```
